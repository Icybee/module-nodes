...
define('icybee/nodes/adjust-node', [
	...
	return new Class ({
		...
		initialize: function(el, options)
		{
			...
			this.element.addDelegatedEventListener('.records [data-nid]', 'click', function(ev, el) {
			...
			this.element.addDelegatedEventListener('.pagination a', 'click', function(ev, el) {

				ev.stop()

				var page = el.getAttribute('href').split('#')[1]
...
!function (Brickrouge) {
	...
	Brickrouge.register('AdjustNode', function (element, options) {
